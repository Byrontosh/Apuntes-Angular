...
export class Convert {
  public static toDetallePais(json: string): DetallePais {
      return cast(JSON.parse(json), r("DetallePais"));
  }

  public static detallePaisToJson(value: DetallePais): string {
      return JSON.stringify(uncast(value, r("DetallePais")), null, 2);
  }
}
